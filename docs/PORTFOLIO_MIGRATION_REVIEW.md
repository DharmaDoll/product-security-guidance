...
| [PSB-REL-002 Provenance publication / distribution](https://github.com/DharmaDoll/product-security-controls/blob/f42987759218c9b8daf3924320542a1935ef78e0/controls/release-integrity/provenance-publication-distribution/README.md) | `deferred`: digestとの結合、発見・保持・downgrade防止 | 生成したこととconsumerが取得して照合できることは別 |
...
| Runtime / cloud / IaC | [REF-USER-003](https://github.com/DharmaDoll/product-security-controls/blob/f42987759218c9b8daf3924320542a1935ef78e0/docs/SECURITY_GUIDANCE_SOURCES.md#ref-user-003)、[Docker](https://github.com/DharmaDoll/product-security-controls/blob/f42987759218c9b8daf3924320542a1935ef78e0/docs/SECURITY_GUIDANCE_SOURCES.md#ref-container-001)、[Kubernetes](https://github.com/DharmaDoll/product-security-controls/blob/f42987759218c9b8daf3924320542a1935ef78e0/docs/SECURITY_GUIDANCE_SOURCES.md#ref-container-002)、[Falco](https://github.com/DharmaDoll/product-security-controls/blob/f42987759218c9b8daf3924320542a1935ef78e0/docs/SECURITY_GUIDANCE_SOURCES.md#ref-container-003)、[Sysdig](https://github.com/DharmaDoll/product-security-controls/blob/f42987759218c9b8daf3924320542a1935ef78e0/docs/SECURITY_GUIDANCE_SOURCES.md#ref-container-004) | admission、host、観測、配送、health、対応を分ける。旧Falco 0.44.0やmutableなSysdig文書を現在の仕様と断定しない |
